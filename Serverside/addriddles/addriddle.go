...
// 		riddles[i].ID = riddles[i].ID + 676
// 		errs := db.Where("ID = ?", riddles[i].ID).Delete(&database.Riddle{}).Error
// 		if errs != nil {
// 			fmt.Println("Error Deleting Items", errs)
// 			os.Exit(1)
// 		}
// 	}
...
// 	// 		// Delete Choices associated with the Riddle ID
// 	// 		if err := tx.Where("riddle_id = ?", i).Delete(&database.Choice{}).Error; err != nil {
// 	// 			return err
// 	// 		}

// 	// 		// Delete Hints associated with the Riddle ID
// 	// 		if err := tx.Where("riddle_id = ?", i).Delete(&database.Hint{}).Error; err != nil {
// 	// 			return err
// 	// 		}

// 	// 		// If both deletions succeed, return nil
// 	// 		return nil
// 	// 	})

// 	// 	// Handle errors outside the transaction
// 	// 	if err != nil {
// 	// 		fmt.Printf("Failed to delete data for riddle_id %d: %v\n", i, err)
// 	// 	} else {
// 	// 		fmt.Printf("Successfully deleted data for riddle_id %d\n", i)
// 	// 	}
// 	// }
...
// 	// 	for j := 0; j < len(riddles[i].Choices); j++ {
// 	// 		riddles[i].Choices[j].RiddleID += 676
// 	// 	}
// 	// 	for k := 0; k < len(riddles[i].Hints); k++ {
// 	// 		riddles[i].Hints[k].RiddleID += 676
// 	// 	}
